...
# app = Flask(__name__, static_url_path='/assets')  #for diff folder

# load files===========================================================================================================
trending_products = pd.read_csv("artifacts/csv/trending_product.csv")
train_data = pd.read_csv("artifacts/csv/clean_data.csv")


# database configuration---------------------------------------
# app.secret_key = "bfrwtnuymreertwn5yme47brtyndhfg"
...
#     random_product_image_urls = [random.choice(random_image_urls) for _ in range(len(trending_products))]
#     price = [40, 50, 60, 70, 100, 122, 106, 50, 30, 50]
#     return render_template('main.html',contet_based_rec=0,truncate = truncate,
#                            random_product_image_urls=random_product_image_urls,
#                            random_price = random.choice(price))
